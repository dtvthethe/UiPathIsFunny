...
namespace UiPathIsFunny.Utility
{
    public static class Export
    {
        ...
        public static void ToJSON(List<ActivityReport> activityReports, string pathFile)
        {
        ...
        public static void ToCSV(List<ActivityReport> activityReports, string directoryFolder)
        {
            string path = Path.Combine(directoryFolder, "Export_To_CSV_" + DateTime.Now.ToString("yyyyMMdd_HHmmss"));
        ...
        public static void ToExcel(List<ActivityReport> activityReports, string pathFile)
        {
            ...
            {
                // Sheet name:
                var ws = wb.Worksheets.Add(Path.GetFileNameWithoutExtension(_.FileName));
                // Title:
